...
export default {
  ...
  data: () => {
    return {
      pokemon: [],//pokemon courant
      list_pokemons: [],//liste de tous les pokemons
      pokemonInfo: [],//stocke les infos du pokemon de l'api
      estAffiche: false,//bool affichage detail
      url: config.IMG_URL,//url image

    };
  },
  beforeMount() {
    //récupération des valeurs pour le pokemon
